...
1. How would you describe acessibility on the web to someone new to programming?
    a) it basically means to design websites so that people with disabilitites can use them.

2. Talk about 3 different things you can do to ensure your website is accessible. 
    1) image alt texts - in case people can't see the image shown.
    2) Headings - The bigger the text, the easier it can be read by people.
    3) Language Selectors - The website can be accessed by people of multiple languages.

3. How would you explain the concept of a variable to someone new to programming?
    a) a variable is a line of code that can hold a value. it can be anything and can be changed anytime.

4. What is the purpose of using functions in code?
    a) functions can be used over and over again, it can be used in several different programs.
